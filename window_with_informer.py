...
class SaveTrainingLossCallback(pl.Callback):
    def __init__(self, log_file='epoch_loss_log_window_informer_model.txt'):
...
class ModelTrainer:
    ...
    def train_model(self, train_data, window_number):
        ...
        model = Informer(
            ...
            loss=MAE(),
            learning_rate=5e-4,
            max_steps=1000,  # Adjusted as per your code
...
output_csv_file = 'prediction_using_window_method_informer_model.csv'
